...
<body>
    ...
    <div class="row d-flex">
      ...
      <div class="col">
        <div class="px-5 py-5">
          ...
          <p>lorem ipsum jasdfjahs;kdhfkla;hsdjfg</p>
          </div>
          <div class="px-2 py-2">
  ...
  <!--  Card container  -->
  <div class="card-container bg-black">
    <div class="container-fluid px-3 py-3">
      ...
      <div class="row mb-5">
        <div class="col">
          <div class="card" >
    <img src="https://img.freepik.com/free-vector/work-time-concept-illustration_114360-1474.jpg?w=740&t=st=1667038053~exp=1667038653~hmac=7f51a4d7c9f7dc9e0e3a6d53d45f381fc455e5424bcc36a0bedca65db24487e7" class="card-img-top" alt="...">
    <div class="card-body">
      ...
      <a href="#" class="btn org-btn">Go somewhere</a>
            ...
            <div class="col">
          <div class="card" >
    <img src="https://img.freepik.com/free-vector/work-time-concept-illustration_114360-1074.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      <a href="#" class="btn org-btn">Go somewhere</a>
            ...
            <div class="col">
          <div class="card" >
    <img src="https://img.freepik.com/free-vector/teaching-concept-illustration_114360-1708.jpg?w=740&t=st=1667038099~exp=1667038699~hmac=d144ede4a891a4bfcb57b109cc26614850ed35f5260bbf32541845325c476dbb" class="card-img-top"  alt="...">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      <a href="#" class="btn org-btn">Go somewhere</a>
  ...
  <div class="testimonals-container mt-4 mb-4">
    <div class="container-fluid">
